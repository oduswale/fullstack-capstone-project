...
function MainPage() {
  ...
  return (
    <div
      ...
      style={{
        maxHeight: 'calc(100vh - 100px)', // occupy almost full height
            ...
            <div className="card product-card h-100">
              ...
              >
                {gift.image ? (
                  ...
                  <div className="no-image-available d-flex align-items-center justify-content-center h-100 text-muted">
                    No Image Available
                  </div>
                )}
              </div>
